...
func buildJoinedEvent(roomID string, joinerID id.UserID) *userpb.NotifyRoomEventRequest {
...
func buildLeftEvent(roomID string, leaverID id.UserID) *userpb.NotifyRoomEventRequest {
	return &userpb.NotifyRoomEventRequest{
		RoomId:    roomID,
...
// posted chat message.
func buildForwardMessage(roomID string, senderID id.UserID, text string, timestamp time.Time) *userpb.ForwardMessageRequest {
